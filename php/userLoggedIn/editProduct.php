        ...
        <div class="container-fliud">
            <div class="wrapper row">
                ...
                <div class="details col-md-6">
                    <center>
                    <form action="../main.php?tipo=modificarProducto" method="post" enctype="multipart/form-data">
                        <?php
                                ...
                                <div class="col-md-6" style="margin-top:10px;">
                                    <div class="form-group">
                                        ...
                                        <select name="tema" class="select_box semi-square" required>
                                            <?php $tema = select_nombre_tema_producto($row['tema']) ?>
                        ...
                        <form action="../main.php?tipo=eliminarProducto" method="post" enctype="multipart/form-data">
                            <div class="modal-footer">
