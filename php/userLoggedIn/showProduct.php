            ...
            <div class="container-fliud">
                <div class="wrapper row">
                    ...
                    <div class="preview col-md-4">
                        ...
                        <?php
                        $idUsuario = select_idUsuario_producto($idProducto);
                        $sinImagen=$idUsuario.'_';
                        $imagen1 = select_imagen_producto(1,$idProducto);
                        $imagen2 = select_imagen_producto(2,$idProducto);
                        $imagen3 = select_imagen_producto(3,$idProducto);
                        $imagen4 = select_imagen_producto(4,$idProducto);
                        $imagen5 = select_imagen_producto(5,$idProducto);
                        if($imagen1!=$sinImagen){
                            $url1='../../img/products/'.$idUsuario.'/'.$imagen1;
                        }else{
                            $url1='../../img/nodisponible.jpg';
                        }
                        if($imagen2!=$sinImagen){
                            $url2='../../img/products/'.$idUsuario.'/'.$imagen2;
                        }else{
                            $url2='../../img/nodisponible.jpg';
                        }
                        if($imagen3!=$sinImagen){
                            $url3='../../img/products/'.$idUsuario.'/'.$imagen3;
                        }else{
                            $url3='../../img/nodisponible.jpg';
                        }
                        if($imagen4!=$sinImagen){
                            $url4='../../img/products/'.$idUsuario.'/'.$imagen4;
                        }else{
                            $url4='../../img/nodisponible.jpg';
                        }
                        if($imagen5!=$sinImagen){
                            $url5='../../img/products/'.$idUsuario.'/'.$imagen5;
                        }else{
                            $url5='../../img/nodisponible.jpg';
                        }
                        ?>
                        ...
                        <div class="preview-pic tab-content">
                            ...
                            <div class="tab-pane bordeImagenArticulo" id="pic-4"><img src="<?php echo $url4 ?>" /></div>
                            <div class="tab-pane bordeImagenArticulo" id="pic-5"><img src="<?php echo $url5 ?>" /></div>
                        </div>
                        <ul class="preview-thumbnail nav nav-tabs">
                            ...
                            <li class="bordeImagenArticulo"><a data-target="#pic-4" data-toggle="tab"><img src="<?php echo $url4 ?>" /></a></li>
                            <li class="bordeImagenArticulo"><a data-target="#pic-5" data-toggle="tab"><img src="<?php echo $url5 ?>" /></a></li>
                        </ul>

                    </div>

                    <?php
                    $data = select_producto($idProducto);
                    if ($data->num_rows > 0) {
                        // output data of each row
                        while ($row = $data->fetch_assoc()) {
                            $_SESSION['ID_USUARIO_PRODUCTO'] = $row['ID_usuario'];
                    ?>
                    ...
                    <div class="details col-md-8">
                        ...
                        <?php
                            if($_SESSION['ID_USUARIO_PRODUCTO']!=$_SESSION['ID_USUARIO']) {
                        ?>
                        ...
                        <div class="form-group">
                            ...
                            <span onclick="perfilUsuario(<?php echo $row['ID_usuario'] ?>)" class="nombreUsuario glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                        </div>

                        <p class="product-description"><?php echo $row['descripcion']?></p>
                        <h4 class="price">Precio: <span><?php echo $row['precio']?> €</span></h4>
                        <!-- CHAT -->
                        <div>
                            <?php
                            if($_SESSION['ID_USUARIO_PRODUCTO']!=$_SESSION['ID_USUARIO']) {
                                ?>
                                <center>
                                    <button type="submit" class="botonAbrirChat">Abrir</br></br>chat</button>
                                </center>
                                <?php
                            }
                            ?>
