...
$_SESSION['nombreProducto'] = mysqli_real_escape_string($con, $_POST['nombre']);
$_SESSION['ciudadProducto'] = mysqli_real_escape_string($con, $_POST['ciudad']);
$_SESSION['descripcionProducto'] = mysqli_real_escape_string($con, $_POST['descripcion']);
$_SESSION['precioProducto'] = mysqli_real_escape_string($con, $_POST['precio']);
$_SESSION['temaProducto'] = mysqli_real_escape_string($con, $_POST['tema']);
...
echo "<script type='text/javascript'>location.href='../../main.php?tipo=producto';</script>";
