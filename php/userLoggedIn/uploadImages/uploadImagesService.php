...
$_SESSION['nombreServicio'] = mysqli_real_escape_string($con, $_POST['nombre']);
$_SESSION['ciudadServicio'] = mysqli_real_escape_string($con, $_POST['ciudad']);
$_SESSION['descripcionServicio'] = mysqli_real_escape_string($con, $_POST['descripcion']);
$_SESSION['precioServicio'] = mysqli_real_escape_string($con, $_POST['precio']);
$_SESSION['temaServicio'] = mysqli_real_escape_string($con, $_POST['tema']);
...
echo "<script type='text/javascript'>location.href='../../main.php?tipo=servicio';</script>";
