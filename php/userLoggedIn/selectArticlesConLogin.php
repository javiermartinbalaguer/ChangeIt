...
<center>
    <!-- BOTONES PARA ORDENAR PRODUCTOS -->
        <div class="panelbotones1 btn-group btn-group-justified" role="group">

            <div class="fila2 btn-group btn-group-justified" role="group">
                <form id="NombreProductoDesc" class="btn-group" role="group" action="userMain.php" method="post" enctype="multipart/form-data">
                ...
                <form id="NombreProductoAsc" class="btn-group" role="group" action="userMain.php" method="post" enctype="multipart/form-data">
                ...
                <form id="PrecioProductoDesc" class="btn-group" role="group" action="userMain.php" method="post" enctype="multipart/form-data">
                ...
                <form id="PrecioProductoAsc" class="btn-group" role="group" action="userMain.php" method="post" enctype="multipart/form-data">
                ...
                <form id="FechaProductoDesc" class="btn-group" role="group" action="userMain.php" method="post" enctype="multipart/form-data">
                ...
                <form id="FechaProductoAsc" class="btn-group" role="group" action="userMain.php" method="post" enctype="multipart/form-data">
    ...
    <div id="row">
        ...
        <div id="contenerdorArticulos">
            ...
            <div id="columnas-div" class="col-sm-3 col-md-3">
                ...
                ?>
                <div>
                    <div onclick="showProduct(<?php echo $row['ID_PRODUCTO'] ?>)" class="thumbnail mostrarProducto">
            ...
            <div id="columnas-div" class="col-sm-3 col-md-3">
                ...
                ?>
                <div>
                    <div onclick="showService(<?php echo $row['ID_SERVICIO'] ?>)" class="thumbnail mostrarServicio">
                        <img style="width: 100%" src="<?php
                    if ($imagen1==$row['ID_usuario'].'_'){
                        if ($imagen2==$row['ID_usuario'].'_'){
                            if ($imagen3==$row['ID_usuario'].'_'){
