            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <form class="dropdown-menu" action="main.php?tipo=login" method="POST" style="padding:8px;" >
                        ...
                        <input style="margin-bottom:5px;" type="email" name="correo" id="correo" class="form-control" placeholder="Correo*" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                        <input id="pass" type="password" class="form-control" name="contrasenya" placeholder="Password*"/>
            ...
            <div class="modal-body">
                <form id="formRegistro" action="main.php?tipo=registro" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="correo" id="correo" class="form-control" placeholder="Correo*" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Contraseña</label>
                        <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Contraseña*" style="margin-bottom:5px;">
                        <input type="password" name="contrasenya" id="contrasenya" class="form-control"  placeholder="Repite la contraseña*" style="margin-bottom:5px;">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="enviar" Value="Registrarse" enabled>Enviar</button>
                        </div>
                </form>
            </div>
        </div>
